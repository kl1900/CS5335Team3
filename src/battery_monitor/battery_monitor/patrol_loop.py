...
BATTERY_HIGH = 0.62
BATTERY_LOW = 0.55  # when the robot will go charge
...
def main(args=None):
    ...
    # Prepare goal poses
    goal_pose = []
    goal_pose.append(navigator.getPoseStamped([2.78, -4.69], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-1.94, -3.81], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-2.29, -1.47], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0.0992, -1.83], TurtleBot4Directions.NORTH))
